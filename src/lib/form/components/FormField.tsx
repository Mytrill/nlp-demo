...
function getHint(props: BaseProps & BaseField): string | undefined {
...
export function FormField(props: FormFieldProps) {
  ...
  let cls = "form-group"
  if (state.error || props.error) cls += " has-error"
  if (state.info || props.info) cls += " has-success"
  if (props.fieldClass) cls += " " + props.fieldClass
  return (
    <div class={cls}>
